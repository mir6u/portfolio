        ...
        >
          <aside className="fixed text-slate-100 rounded-lg flex flex-col h-full w-full justify-center items-center p-4 gap-5 slide-in-elliptic-top-fwd">
            <button
              ...
              className={`flex ${
                pathname === "/" ? "bg-[#333638]" : null
              } items-center gap-2 py-3 w-56 px-8 rounded-full`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                stroke="currentColor"
            ...
            <button
              ...
              className={`flex ${
                pathname === "/projects" ? "bg-[#333638]" : null
              } items-center gap-2 py-3 w-56 px-8 rounded-full`}
            >
              <svg
                fill="currentColor"
            ...
            <button
              onClick={() => {
                router.push("https://github.com/mir6u");
              }}
              className="flex items-center gap-2 py-3 w-56 px-8 rounded-full"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <button
              onClick={() => {
                router.push("mailto:test@example.com");
              }}
              className="  flex items-center gap-2 py-3 w-56 px-8 rounded-full"
            >
              <svg
